...
exports.resumeList = exports.deleteResume = exports.updateResume = exports.addResume = void 0;
...
const addResume = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [template] = yield db_1.default.query(checkTemplate, [templates_id]);
...
const resumeList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [resumeData] = yield db_1.default.query(getUserAllTemplate, [userId]);
