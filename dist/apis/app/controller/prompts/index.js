...
const tagSuggestion = __importStar(require("./tagSuggestion"));
const languaSuggestion = __importStar(require("./language"));
const fieldSuggestion = __importStar(require("./field_study"));
const skillSuggestion = __importStar(require("./skills"));
const suggestionRouter = (0, express_1.Router)();
