...
const prompts_1 = __importDefault(require("./controller/prompts"));
const uploads_1 = __importDefault(require("./controller/uploads"));
...
appRoute.use('/prompts', prompts_1.default);
appRoute.use('/upload', uploads_1.default);
